        ...
        <nav class="navbar navbar-default header-nav" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <!-- Logo -->        
                    <a class="navbar-brand" href="index.html"><img src="img/logonew.png" class="img-responsive" alt="suryasterling"></a>        
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                       ...
                       <!-- <li><a href="#projects">Projects</a></li>     -->               
                        ...
                        <ul class="dropdown-menu" role="menu">
                                     <li><a href="resident.html">Designer</a></li>
                                    <li><a href="luxury.html">Designer</a></li>
                                    <li><a href="turnkeyproject.html">All</a></li>
                                    <li><a href="officefurniture.html">Supplier</a></li>
                                     <!-- <li><a href="#">Modular Kitchen and wardrobe Manufacturer</a></li>
                                   <li><a href="architect.html">Architecture in Delhi NCR</a></li> -->
                                     <li><a href="projectman.html"> Management</a></li>                                   
                                </ul>
                        </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-md-6">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <address>                            
                                                <small>
                                                   info@suryasterling.com
                                                   
                                                </small>
                                                <small>
                                                  lokeshbhati@suryasterling.com                  
                                                </small>
                                            </address>
                                        </div>
                                    </div>                                                                                        
                    ...
                    <div class="col-md-6 col-sm-6 f-inner">   
                            ...
                            <div class="col-sm-11">
                               ...
                               <address>                                
                                    ...
                                    info@suryasterling.com<br/>
                                    abc@suryasterling.com
                                </address>
                            </div>      
                        </div>                          
